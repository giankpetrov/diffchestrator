...
test("timeAgoShort", () => {
  ...
  assert.strictEqual(timeAgoShort(oneMinuteAgo), "1m ago");
  assert.strictEqual(timeAgoShort(minutesAgo), "5m ago");
  assert.strictEqual(timeAgoShort(oneHourAgo), "1h ago");
  assert.strictEqual(timeAgoShort(hoursAgo), "3h ago");
  assert.strictEqual(timeAgoShort(oneDayAgo), "1d ago");
  assert.strictEqual(timeAgoShort(daysAgo), "4d ago");
  assert.strictEqual(timeAgoShort(oneWeekAgo), "1w ago");
  assert.strictEqual(timeAgoShort(weeksAgo), "2w ago");
  assert.strictEqual(timeAgoShort(oneMonthAgo), "1mo ago");
